  ...
  return (
    <div>
      ...
      <div className="flex flex-col min-h-[60vh] overflow-hidden">
        ...
        {/* Hero */}
        <section className="-mt-[100px] relative h-[calc(60vh)] overflow-hidden lg:min-h-[calc(100vh)] flex flex-col bg-[#333]">
        ...
        <section className="h-[400px] flex flex-col md:flex-row items-center justify-center mt-20  mx-[10%]">
          <div className="text-center md:text-left max-w-xl">
            ...
            <p className="text-lg md:text-xl text-gray-900">
              Skillfull is a bootcamp Programs designed & delivered by experts
