  ...
  return (
    <div>
      ...
      <div className="flex flex-col min-h-[60vh] overflow-hidden">
        ...
        <div className=" mx-[2%] md:mx-[10%] lg:mx-[10%] mt-[150px]">
          {/* Section */}
          <section className="lg:bg-gray-100 p-[5%] rounded-3xl min-h-[400px] flex flex-col md:flex-row items-start justify-evenly">
            <MotionViewHorizontal>
              <div className="text-center md:text-left max-w-[64%] xl:max-w-[90%]">
                ...
                <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl text-gray-900">
                  Skillfull is a bootcamp Programs designed & delivered by
                  experts with over 13 years of experience.
                </p>
            ...
            <div className="w-[150%] xl:w-[120%]">
              <MotionView none>
                <img
                  className="w-full h-full border hidden md:block max-h-[100%] rounded-[30px] shadow-xl ml-[5%]"
          ...
          <section className="h-[400px] flex flex-col md:flex-row items-center justify-center mt-20">
            <Accordion />
          </section>
