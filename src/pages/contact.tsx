  ...
  return (
    <div>
      ...
      <div className="flex flex-col overflow-hidden">
        ...
        <div className="mt-[200px] container my-24 px-6 mx-auto">
          <section className="mb-32 text-gray-800">
            <div className="flex justify-center">
              <div className="text-center lg:max-w-3xl md:max-w-xl">
                <h2
                  className="text-3xl font-bold mb-12 px-6"
                  style={{ fontFamily: "League Spartan !important" }}
                >
                  Contact us
                </h2>
              </div>
            ...
            ease-in-out
            m-0
            focus:text-gray-700 focus:bg-white focus:border-[#F5F147] focus:outline-none"
                      id="exampleInput7"
                      placeholder="Name"
                    />
                  </div>
          ...
          "
                  ...
                  <div className="form-group form-check text-center mb-6">
                    <input
                      type="checkbox"
                      className="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-[#333] checked:border-[#333] focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
                      id="exampleCheck87"
                      defaultChecked
                    />
                    <label
                  ...
                  <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                    <div className="flex items-start">
                      <div className="shrink-0">
                        <div className="p-4 bg-[#333] rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
