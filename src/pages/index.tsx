  ...
  return (
    <div className="light bg-white text-black">
      ...
      <div className="flex flex-col min-h-screen overflow-hidden">
            ...
            <div className="pt-[15vh] lg:pt-[20vh] max-w-8xl mx-auto px-4 sm:px-6 relative">
              ...
              "
                  ...
                  <div className="flex justify-center mx-[15%] lg:mt-16">
                    ...
                    <div
                      className="flex-grow flex-5 max-w-xs mx-auto sm:max-w-none sm:flex items-center sm:justify-center xl:mt-8"
                      data-aos="zoom-y-out"
                      data-aos-delay={300}
                    >
        ...
        {/* Container */}
        <div className="mx-[5%] md:mx-[10%] lg:mx-[10%] mt-0 lg:mt-[100px]">
          {/* Section */}
          <section className="lg:bg-gray-100 p-[5%] rounded-3xl min-h-[400px] flex flex-col-reverse lg:flex-row items-start justify-evenly">
            <MotionViewHorizontal>
              <div className="text-left lg:max-w-[90%] xl:max-w-[100%] mt-5">
                <h2
          ...
          {/* Why Us */}
          <section className="relative mb-[60px] lg:mb-[200px]">
            <div
              className="
          absolute
          left-1/2
        ...
        "
            ...
            <div className="mt-[50px] md:mt-[150px] lg:mt-[200px] mx-auto ml-[5%] sm:ml-0">
              <MotionView>
                <h2
                  className="medium-large-font font-[800] my-0 tracking-tight mb-5"
                  style={{
            ...
            <div className="mt-[20px] md:mt-[50px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 z-[999] relative">
              ...
              <div className="lg:border-r-[3px] border-yellow-400 mx-5 ml-[5%] sm:ml-0">
                <h1
                  className="medium-font mb-3 font-[500]"
                  style={{
                    fontFamily: "League Spartan !important"
          ...
          {/* Programs */}
          <section className="mb-[30px] max-w-5xl text-left lg:mx-auto mt-[60px] md:mt-[100px] lg:mt-[300px] ml-[5%] sm:ml-0">
            <h2
              className="medium-large-font font-[800] my-0 tracking-tight mb-5"
              style={{
                fontFamily: "League Spartan !important"
          ...
          <section className="relative min-h-[300px] py-[12vh] border flex flex-col md:flex-row items-center justify-evenly bg-gradient-to-r from-indigo-800 via-purple-700 to-pink-500 text-white rounded-3xl">
            <div className="text-center md:text-left max-w-2xl xl:max-w-4xl">
              <h2
            ...
            <div className="hidden lg:block text-white absolute bottom-[5vh] scale-150 right-[24%] -rotate-90 ">
              <svg
                width="65"
                height="208"
                viewBox="0 0 65 208"
              ...
              >
                <path
                  d="M16.8634 140.618C17.4702 142.034 18.5489 145.378 20.275 148.979C20.6795 149.882 21.111 150.826 21.5425 151.77C21.9606 152.714 22.4999 153.618 22.9719 154.535C23.9698 156.342 24.8058 158.162 25.7767 159.618C29.8626 166.63 34.744 173.144 40.0705 179.239C45.4104 185.334 51.2357 190.984 57.4926 196.189C59.5018 197.739 63.0483 200.194 61.3492 202.729C59.5962 205.358 56.0093 205.183 52.1662 202.351C43.0775 195.245 35.4182 186.642 28.0152 178.038C22.6213 171.714 17.9421 164.729 14.2069 157.286C10.4447 149.842 7.45
                  fill="black"
                />
              </svg>
            </div>
          ...
          {/* Road Map */}
          <section className="flex flex-col w-full justify-center my-[100px]">
            {/* <img
          ...
          /> */}
            <div className="mb-10">
              ...
              <p className="medium-font">
                A Full-Stack Development Course Road Map.
              </p>
            </div>
            <Timeline />
            <div className="relative">
              <svg
                className="hidden sm:block absolute right-[calc(50%-140px)] scale-75 -top-[20px] sm:-top-[80px] rotate-[30deg]"
                width="50"
                height="161"
                viewBox="0 0 50 161"
                fill="none"
              ...
              >
                <path
                  d="M41.3808 106.949C40.8953 108.068 39.8435 110.63 38.4411 113.435C37.7669 114.851 37.0387 116.348 36.2701 117.777C35.515 119.206 34.8272 120.622 34.1395 121.809C28.1254 133.001 20.6279 143.33 11.8359 152.257C10.447 153.633 8.24897 156.127 6.024 154.051C3.70464 151.88 3.73161 149.035 5.95658 146.634C11.2965 140.755 16.7173 134.768 20.574 127.837C26.2105 117.764 31.7662 107.731 35.3397 96.9027C36.9174 92.0482 38.1984 87.1129 39.1963 82.137C40.1402 77.1342 40.6526 72.118 40.7335 67.0748C40.6796 57.5816 38.8187 48.2231 35.9869 39.3502C33.6136 31.6909 30.7953 23.9911 26.1566 17.3297C25.6037 16.5476 24.8756 15.7925 24.1339 15.0104C23.3518 14.2687 22.5157 13.5676 21.855 12.772C20.8167 11.3966 18.7266 9.48181 17.7017 8.09289C17.2702 7.47259 16.7443 6.91953 16.124 6.54195C13.2653 4.88334 13.2248 3.41372 16.2049 1.36406C16.8792 0.919063 17.2432 -0.0787492 18.2411 0.0695821C18.2816 0.0695821 18.3625 0.0830799 18.4029 0.0830799C20.102 0.0965645 21.3695 0.770666 22.4618 1.63368C23.4866 2.57761 24.3362 3.72382 25.3745 4.68123C35.3397 14.3362 42.028 26.9039 45.7363 40.0515C47.9883 48.1692 48.9457 56.5431 49.3772 64.9171C49.5525 67.2095 49.8492 69.5425 49.4581 71.8619V71.8214C49.4716 73.0485 49.3907 74.2621 49.3232 75.4892C49.2423 76.7163 49.1884 77.9434 48.9996 79.157C47.6242 88.2591 45.2509 97.6444 41.7718 105.708C41.637 105.991 41.583 106.477 41.3808 106.949Z"
                  fill="black"
                />
                <path
                  d="M14.6119 147.673C15.3131 147.349 17.8348 146.311 19.3855 145.529C22.9859 143.708 26.6403 141.969 30.6991 141.119C31.3329 140.985 32.3038 140.54 33.5983 143.304C34.9468 146.176 35.0951 148.158 34.0433 148.522C31.5217 149.399 28.7978 149.898 26.6403 151.53C23.4983 153.916 19.817 155.197 16.4054 157.004L15.2188 157.611L13.1151 158.636C11.7127 159.351 10.2564 159.958 8.98884 160.173C7.72129 160.403 6.54812 160.389 5.41541 160.079C4.29618 159.809 3.10953 159.014 2.34091 158.056L2.26 157.948C1.58577 157.031 1.2082 156.155 0.951987 155.036C0.682294 153.93 0.709259 152.447 0.978952 150.909L1.31607 148.59L1.49137 147.403L1.57228 146.716C1.66667 145.907 1.80152 145.098 1.96334 144.302C2.54318 141.551 3.87816 138.949 4.71421 136.252C4.91648 135.618 4.51194 134.728 4.70072 134.026C4.86254 133.447 5.07829 132.476 5.45586 131.936C5.61768 131.707 5.81995 131.478 5.75252 131.208C5.46935 129.968 6.61555 129.887 9.95974 130.965C10.6879 131.195 11.6993 131.303 12.1577 131.68C12.1712 131.694 12.2117 131.721 12.2386 131.748C14.14 133.002 13.0073 133.649 12.8859 134.526C12.2656 138.787 11.443 143.007 10.7014 147.241L10.3508 149.076C10.3238 149.21 10.2969 149.331 10.2969 149.453C10.2834 149.696 10.2834 149.938 10.5261 149.925C10.58 149.925 10.7014 149.857 10.8093 149.776C10.9846 149.669 11.1059 149.534 10.9711 149.763C11.1464 149.642 11.3082 149.345 11.3082 149.359C11.3352 149.372 11.3756 149.278 11.3621 149.251V149.237L12.333 148.779C12.9803 148.482 13.641 148.212 14.3018 147.97C14.3962 147.929 14.4636 147.741 14.6119 147.673Z"
                  fill="black"
                />
              </svg>
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="block sm:hidden absolute right-[calc(50%-140px)] scale-90 left-[20%] top-[40px] sm:-top-[80px] rotate-[90deg]"
              >
                <path
                  d="M54.27 0.603444C54.97 0.533444 56.55 0.293444 58.37 0.203444C60.18 0.0534438 62.2299 0.0334438 63.8199 0.00344376C71.1899 -0.0765562 78.6599 1.23344 85.3399 4.33344C86.3699 4.84344 88.19 5.55344 87.28 7.62344C86.33 9.78344 84.7199 10.6334 83.0799 9.92344C79.0499 8.29344 74.78 6.78344 70.37 6.71344C63.98 6.58344 57.59 6.61344 51.38 8.03344C48.6 8.67344 45.8799 9.50344 43.2099 10.4734C40.5499 11.4734 37.98 12.7034 35.52 14.1234C30.93 16.8834 26.9699 20.4934 23.2399 24.2234C19.9999 27.4134 16.6699 30.6534 14.0699 34.5034C13.7699 34.9534 13.5299 35.5134 13.2999 36.0834C13.0899 36.6634 12.8799 37.2634 12.5799 37.7734C12.0599 38.6034 11.37 40.0834 10.76 40.8834C10.49 41.2234 10.24 41.5934 10.15 42.0034C9.77998 43.8834 8.81999 44.0734 6.65999 42.5334C6.18999 42.1934 5.42997 42.0834 5.25997 41.4734C5.24997 41.4434 5.23994 41.3934 5.22994 41.3734C4.78994 40.3834 4.8999 39.5734 5.1899 38.8434C5.5099 38.1234 6.00991 37.4934 6.32992 36.7734C9.60991 29.7334 14.3099 23.3934 19.9199 18.0034C23.3799 14.7034 27.2699 11.9134 31.2299 9.22344C32.2999 8.46344 33.3199 7.56344 34.5899 7.12344L34.5699 7.13344C35.7699 6.41344 36.99 5.72344 38.27 5.14344C43.15 3.09344 48.47 1.40344 53.52 0.823444C53.73 0.773444 53.98 0.643444 54.27 0.603444Z"
                  fill="black"
                />
                <path
                  d="M12.4499 38.2041C12.9999 38.0141 14.9699 37.4141 16.1899 36.9341C19.0299 35.8241 21.9 34.7841 25 34.4141C25.49 34.3541 26.25 34.0941 27.01 36.2241C27.8 38.4441 27.7599 39.9141 26.9599 40.1141C24.9999 40.6041 22.9199 40.7841 21.1799 41.8541C18.6399 43.4141 15.7899 44.1141 13.0899 45.2341C12.0299 45.6741 10.96 46.0641 9.89 46.4541L9.23997 46.6841C8.98997 46.7641 8.74998 46.8441 8.49998 46.9141C7.99998 47.0541 7.49999 47.1541 7.00999 47.1941C6.01999 47.2941 5.03999 47.1641 4.12999 46.7941C3.60999 46.5541 3.09002 46.2841 2.66002 45.8941C1.85002 45.2141 1.23993 44.3241 0.819929 43.3041C0.399929 42.3041 0.199978 41.0741 0.119978 39.9841C0.0799778 39.6041 0.0699094 39.1741 0.0499094 38.8741L0.00999241 37.9441C-0.0100076 37.3241 2.17073e-05 36.7141 0.0400217 36.0941C0.170022 33.9741 0.859914 31.8841 1.17991 29.7741C1.25991 29.2741 0.869914 28.6541 0.929914 28.1041C0.979914 27.6541 1.03999 26.8941 1.25999 26.4641C1.34999 26.2741 1.47001 26.0841 1.40001 25.8841C1.06001 24.9941 1.88994 24.8041 4.45994 25.2341C5.01994 25.3241 5.77001 25.2941 6.15001 25.5241C6.17001 25.5341 6.19995 25.5541 6.21995 25.5641C7.74995 26.2841 6.98997 26.9041 6.98997 27.5641C6.99997 30.8141 6.85 34.0541 6.77 37.3041L6.70994 38.7941C6.68994 39.3041 6.65991 39.7741 6.67991 40.0541C6.69991 40.2341 6.78997 40.4441 6.98997 40.4341C7.10997 40.4441 7.34001 40.1541 7.28001 40.3141L7.27 40.3341C7.36 40.2641 7.41002 40.0941 7.41002 40.0941H7.4199L7.42991 40.0841C7.45991 40.0741 7.35991 40.1041 7.54991 40.0341L9.08995 39.4241C10.1199 39.0241 11.15 38.6541 12.16 38.3941C12.27 38.3741 12.3399 38.2441 12.4499 38.2041Z"
                  fill="black"
                />
              </svg>

              <img src="/assets/conf.jpg" className="w-[90px] sm:mx-auto" />

              <div
                className="medium-font font-[900] text-2xl ml-4 lg:text-3xl sm:text-center mt-5"
                style={{
                  fontFamily: "League Spartan !important"
                }}
              >
