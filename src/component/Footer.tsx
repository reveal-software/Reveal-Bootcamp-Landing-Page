...
const Footer = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-700">
      <div className="grid grid-cols-1 gap-8 pb-2 pt-16 px-6 md:grid-cols-5 mx-[2%] md:mx-[10%] lg:mx-[15%]">
        <div className="md:col-span-2">
          ...
          <img
            ...
            className="hidden sm:block w-[200px] md:w-[300px] -mt-[20px] -ml-[38px] md:-ml-[55px]"
          />
        </div>
        ...
        <div>
          <div className="-mt-[25px] py-6 md:flex md:items-center md:justify-between -ml-[10px] md:px-[10%] lg:px-[15%] md:mx-[10%] lg:mx-[15%]">
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
              ...
              >
                <svg
                  className="w-[40px] h-[40px] md:w-[50px] md:w-[50px]"
      ...
      <div className="py-6 md:flex md:items-center md:justify-center ml-[5%] px-[2%] md:px-[10%] lg:px-[15%]">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
          © 2022 <a href="/">Skillfull Academy</a>. | All Rights Reserved.
        </span>
      </div>
    </footer>
  );
